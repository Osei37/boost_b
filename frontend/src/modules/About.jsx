      ...
      <div className={classes.parallaxBg}>
        <div className={classes.scrollBox}>
          <div className={classes.content}>
            ...
            <div className={classes.what}>
              <h2>なぜ始めたのか？</h2>
              <p>運営者は学生時代バスケ部に所属しており，B.LEAGUE 開幕の際にブースターとなりました．B.LEAGUE 観戦を楽しみに生きてます．最近は嬉しいことに，ブースターが増えていると感じていますが，そんな我々ブースターが寂しい思いをする期間があります．そうですオフシーズンです．レギュラーシーズンを終え，残ったチームでのチャンピオンシップやプレイオフを終えると， B.LEAGUE としての活動は一旦終わりになり，試合は行われません．代表が招集されて国際試合が行われるのはこの期間ですが，当然 B.LEAGUE ほど試合数があるわけでもなく，試合会場も限られるため観戦することも難しいわけです．</p>
